...
global $ct_config;
	...
	$sql = "SELECT blog_bits.*,blog_blogs.blog_sname  FROM blog_bits INNER JOIN blog_blogs ON blog_bits.bit_blog = blog_blogs.blog_id WHERE bit_id = $id OR (bit_id = 0 AND bit_rid = $id)";
