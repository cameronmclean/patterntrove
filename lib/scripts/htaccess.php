...
RewriteBase  {$ct_config['blog_path']}
RewriteRule ^claddier/([0-9]+) {$ct_config['blog_path']}claddier/trackback.php?tb_id=$1 [L,QSA]
RewriteCond %{QUERY_STRING} ^$
RewriteRule ^claddier/?$  {$ct_config['blog_path']}claddier/index.php [L,QSA]
RewriteCond %{QUERY_STRING} ^tb_id=([0-9]*)$
RewriteRule ^claddier/?$  {$ct_config['blog_path']}claddier/trackback.php [L,QSA]
...
RewriteCond %{REQUEST_URI} !{$ct_config['blog_path']}cache/.*status$
